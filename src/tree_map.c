...
bool coral$tree_map$iterator_init(struct coral$tree_map$iterator *object,
    ...
    return coral$tree_set$iterator_init(
            &object->iterator, &tree_map->tree_set);
}
...
bool coral$tree_map$iterator_get_next(struct coral$tree_map$iterator *object,
    ...
    return coral$tree_set$iterator_get_next(&object->iterator, out);
}
...
bool coral$tree_map$iterator_delete(struct coral$tree_map$iterator *object) {
    ...
    return coral$tree_set$iterator_delete(&object->iterator);
}

bool
coral$tree_map$iterator_invalidate(struct coral$tree_map$iterator *object) {
    if (!object) {
        coral_error = CORAL_ERROR_OBJECT_PTR_IS_NULL;
        return false;
    }
    return coral$tree_set$iterator_invalidate(&object->iterator);
}
